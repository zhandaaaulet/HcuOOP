...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        //3 task: Нет мы не можем так как мы туда установили модификатор доступа private и он доступен только внутри класса
        ...
        System.out.println (c6); // println () неявно вызывает toString (), как и выше
